...
<body>
      <jsp:useBean id="beanEmploy" class="com.infinite.BeanExample.Employ" scope="page"/>
      ...
      Employ Name:<jsp:getProperty property="name" name="beanEmploy"/><br/>
       Department:<jsp:getProperty property="dept" name="beanEmploy"/><br/>
        Employ Design:<jsp:getProperty property="desig" name="beanEmploy"/><br/>
         Employ Basic:<jsp:getProperty property="basic" name="beanEmploy"/><br/>
</body>
</html>